  ...
  context 'Logic' do
    ...
    context 'And' do
      ...
      it 'should be the right instances' do
        expect(logic).to be_a RulerCoaster::Logic::And
        expect(logic.left).to be_a RulerCoaster::Rule
        expect(logic.right).to be_a RulerCoaster::Rule
      end
    ...
    context 'Not' do
      ...
      it 'should be the right instances' do
        expect(logic).to be_a RulerCoaster::Logic::Not
        expect(logic.left).to be_a RulerCoaster::Rule
        expect(logic.right).to be_a RulerCoaster::Rule
      end
    ...
    context 'Or' do
      ...
      it 'should be the right instances' do
        expect(logic).to be_a RulerCoaster::Logic::And
        expect(logic.left).to be_a RulerCoaster::Rule
        expect(logic.right).to be_a RulerCoaster::Logic::Or
      end
    ...
    context 'Nor' do
      ...
      it 'should be the right instances' do
        expect(logic).to be_a RulerCoaster::Logic::And
        expect(logic.left).to be_a RulerCoaster::Rule
        expect(logic.right).to be_a RulerCoaster::Logic::Nor
      end
