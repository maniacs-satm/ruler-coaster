  ...
  context "Operator" do
    ...
    context "should parse Equal" do
      ...
      it "should assert true" do
        expect(operator.("London")).to eq true
      end

      it "should assert false" do
        expect(operator.("Lisboa")).to eq false
      end
    ...
    context "should parse Not Equal" do
      ...
      it "should assert true" do
        expect(operator.("London")).to eq false
      end

      it "should assert false" do
        expect(operator.("Lisboa")).to eq true
      end
    ...
    context "should parse Greater Than" do
      ...
      it "should assert true" do
        expect(operator.(2017)).to eq true
      end

      it "should assert false" do
        expect(operator.(2015)).to eq false
      end
    ...
    context "should parse Less Than" do
      ...
      it "should assert true" do
        expect(operator.(2015)).to eq true
      end

      it "should assert false" do
        expect(operator.(2017)).to eq false
      end
    ...
    context "should parse Contain" do
      ...
      it "should assert true" do
        expect(operator.(2)).to eq true
      end

      it "should assert false" do
        expect(operator.(5)).to eq false
      end
    ...
    context "should parse Not Contain" do
      ...
      it "should assert true" do
        expect(operator.(5)).to eq true
      end

      it "should assert false" do
        expect(operator.(2)).to eq false
      end
    ...
    context "should parse Empty" do
      ...
      it "should assert false" do
        expect(operator.("abc")).to eq false
      end
    ...
    context "should parse Not Empty" do
      ...
      it "should assert true" do
        expect(operator.("abc")).to eq true
      end

      it "should assert false" do
        expect(operator.("")).to eq false
      end
